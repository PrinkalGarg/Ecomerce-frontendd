...
function Collection() {
  ...
  const handleFilterChange = (e, filterType) => {
    ...
    if (filterType === "category") {
      setCategory(
        checked ? [...category, value] : category.filter((c) => c !== value)
      );
      ...
      <div className="w-full md:w-1/4 p-4">
        ...
        <div className="border-2 p-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => handleFilterChange(e, "category")}
            />
            <label htmlFor="kids" className="ml-2">
              Kids
            </label>
            <br />
          </div>
        ...
        <div className="border-2 p-4 mt-4">
          ...
          <div>
            ...
            />
            <label htmlFor="Topwear" className="ml-2">
              Topwear
            </label>
            <br />
            <input
              ...
              onChange={(e) => handleFilterChange(e, "subcategory")}
            />
            <label htmlFor="Bottomwear" className="ml-2">
              Bottomwear
            </label>
            <br />
            <input
              ...
              onChange={(e) => handleFilterChange(e, "subcategory")}
            />
            <label htmlFor="Winterwear" className="ml-2">
              Winterwear
            </label>
            <br />
          </div>
